...
#600.perlbench
perlbench = Process()
perlbench.executable =  'perlbench_s' + alpha_suffix
# TEST CMDS
...
gcc.executable = 'gcc_s' + alpha_suffix
# TEST CMDS
...
#625.x264_s
x264 = Process() #     : This used to be LiveProcess()
x264.executable = 'x264_s' + alpha_suffix
x264.cmd = [x264.executable] + ['-d', 'foreman_ref_encoder_baseline.cfg']
